...
import TopicIcon from '../../../../static/icon-topic.svg'
...
const Title = styled.div`
  ...
  font-size: ${fontSizes.topicTitle.mobile};
  line-height: 1.44;
  letter-spacing: 1.7px;
  padding-left: 10px;
  ${screen.tabletAbove`
    font-size: ${fontSizes.topicTitle.tablet};
    white-space: nowrap;
  ...
  `}
  ${screen.desktopAbove`
    font-size: ${fontSizes.topicTitle.desktop};
  `}
  ${screen.hdAbove`
    font-size: ${fontSizes.topicTitle.hd};
  `}
`

...
import BookmarkListIcon from '../../static/service-icons/bookmark-list-icon.svg'
import CustomizedLink from './customized-link'
import DonationIcon from '../../static/service-icons/donate-icon.svg'
import get from 'lodash/get'
import PropTypes from 'prop-types'
import React from 'react'
import SearchIcon from '../../static/service-icons/search-icon.svg'
...
import SubscriptionIcon from '../../static/service-icons/subscribe-icon.svg'
